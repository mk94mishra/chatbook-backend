...
from home.comment.models import Comment
from home.comment.schemas import CommentCreate, CommentUpdate


router = APIRouter(prefix='/v1/private/comment', tags=["comment"])
