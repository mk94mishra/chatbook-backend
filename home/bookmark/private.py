...
from home.bookmark.models import Bookmark
from home.bookmark.schemas import BookmarkCreate, BookmarkDelete

router = APIRouter(prefix='/v1/private', tags=["bookmark"])
